...
namespace xdp::aie {
  ...
  inline uint8_t getPortNumberFromEvent(const XAie_Events event)
  {
    ...
    case XAIE_EVENT_PORT_RUNNING_7_MEM_TILE:
    case XAIE_EVENT_PORT_STALLED_7_MEM_TILE:
    case XAIE_EVENT_PORT_IDLE_7_MEM_TILE:
      return 7;
    ...
    case XAIE_EVENT_PORT_RUNNING_6_MEM_TILE:
    case XAIE_EVENT_PORT_STALLED_6_MEM_TILE:
    case XAIE_EVENT_PORT_IDLE_6_MEM_TILE:
      return 6;
    ...
    case XAIE_EVENT_PORT_RUNNING_5_MEM_TILE:
    case XAIE_EVENT_PORT_STALLED_5_MEM_TILE:
    case XAIE_EVENT_PORT_IDLE_5_MEM_TILE:
      return 5;
    ...
    case XAIE_EVENT_PORT_RUNNING_4_MEM_TILE:
    case XAIE_EVENT_PORT_STALLED_4_MEM_TILE:
    case XAIE_EVENT_PORT_IDLE_4_MEM_TILE:
      return 4;
    ...
    case XAIE_EVENT_PORT_RUNNING_3_MEM_TILE:
    case XAIE_EVENT_PORT_STALLED_3_MEM_TILE:
    case XAIE_EVENT_PORT_IDLE_3_MEM_TILE:
      return 3;
    ...
    case XAIE_EVENT_PORT_RUNNING_2_MEM_TILE:
    case XAIE_EVENT_PORT_STALLED_2_MEM_TILE:
    case XAIE_EVENT_PORT_IDLE_2_MEM_TILE:
      return 2;
    ...
    case XAIE_EVENT_PORT_RUNNING_1_MEM_TILE:
